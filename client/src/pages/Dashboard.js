    ...
    return(
        <section class="user-dashboard">
            ...
            <div>
                ...
                <h6>{
                        localStorage.getItem("work-interval") % 4 === 0 && startTimer === false && workIntervalCount !== 0
                        ? "You've completed 4 work sessions in row, time for a break!" 
                        : ""
                    }
                </h6>
                
                <h3 style={{marginTop: "50px"}}>Work Intervals Completed: {localStorage.getItem("work-interval")}</h3>
